      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200/60 p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="text-sm font-semibold text-slate-900">Информация о системе</h2>
          </div>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2.5 border-b border-slate-100">
              <span className="text-sm text-slate-500">Telegram бот</span>
              <span className="inline-flex items-center gap-1.5 text-sm font-medium text-emerald-600">
                <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                Активен
              </span>
        ...
        <div className="bg-white rounded-xl border border-slate-200/60 p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="text-sm font-semibold text-slate-900">Ваш профиль</h2>
          </div>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <p className="font-semibold text-slate-900">Координатор</p>
              <p className="text-sm text-slate-500">Полный доступ к панели управления</p>
            </div>
          </div>
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between py-2.5">
              <span className="text-sm text-slate-500">Авторизация</span>
        ...
        <div className="bg-white rounded-xl border border-slate-200/60 p-6 lg:col-span-2">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="text-sm font-semibold text-slate-900">Ссылки</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <a
              ...
              className="flex items-center gap-3 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 hover:border-slate-200 transition-all group"
            >
              <div className="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center">
                <Server size={18} className="text-blue-600" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-slate-800">API документация</p>
                <p className="text-xs text-slate-500">Swagger / OpenAPI</p>
              </div>
              <ExternalLink size={14} className="text-slate-400 group-hover:text-primary-600 transition-colors" />
            </a>
            <a
              href="https://t.me/volunteer_plus_bot"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 hover:border-slate-200 transition-all group"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-500">Volunteer+ Bot</p>
              </div>
              <ExternalLink size={14} className="text-slate-400 group-hover:text-primary-600 transition-colors" />
            </a>
          </div>
