          ...
          {submissions.length > 0 ? (
            <div className="space-y-2">
              {submissions.map((sub, idx) => {
                const statusConf = submissionStatusConfig[sub.status] || submissionStatusConfig.pending;
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs font-semibold shrink-0 ${statusConf.className}`}
                    >
                      <StatusIcon size={11} />
                      {statusConf.label}
                    </span>
